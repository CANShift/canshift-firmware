...
constexpr uint32_t kPasskeyBackdropRgb = ThemeTokens::kGroundNight;
...
void PasskeyOverlay::show(uint32_t passkey) {
    ...
    lv_obj_set_style_text_color(prompt, lv_color_hex(ThemeTokens::kDimNight), 0);
    ...
    lv_obj_set_style_text_color(code, lv_color_hex(ThemeTokens::kInkNight), 0);
    ...
    lv_obj_set_style_text_color(hint, lv_color_hex(ThemeTokens::kDimNight), 0);

...
if [[ -f "${SPIFFS_BIN}" ]]; then
    # SPIFFS offset matches the secure partition table (ota_4mb_secure.csv),
    # itself aligned to ota_4mb.csv after the WiFi/SPA removal (#1351). Host-
    # side flashers (Tuner, this script, the QEMU boot-smoke harness) all

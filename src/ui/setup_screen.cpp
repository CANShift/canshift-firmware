// setup_screen.cpp — Landing UI shown when no dashboard.json is loaded.
//
// Extracted from `page_manager.cpp` (issue #704). Pure rendering: a centred
// two-tone logo, version label, "Ready to configure" copy, a hand-drawn USB
// icon that pulses to invite the user to plug in CANShift Studio.

...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_12_nk = {
#else
lv_font_t lv_font_montserrat_12_nk = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_12_NK*/

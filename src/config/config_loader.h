...
//
// Reads dashboard.json, signals.json, and theme.json from SPIFFS/SD.
// Parses JSON using ArduinoJson and populates the CfgDashboard, CfgSignalConfig,
// and CfgTheme structs. Falls back to built-in defaults on parse failure.
...
namespace ConfigLoader {
    ...
    /**
     * Access the loaded theme config.
     */
    const CfgTheme& getThemeConfig();

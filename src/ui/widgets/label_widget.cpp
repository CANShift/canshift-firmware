...
lv_obj_t* LabelWidget::create(lv_obj_t* parent, const CfgWidget& cfg, int16_t yOffset) {
    ...
    if      (cfg.style.fontSize >= 48) font = &lv_font_montserrat_48;
    else if (cfg.style.fontSize >= 32) font = &lv_font_montserrat_32;
    else if (cfg.style.fontSize >= 24) font = &lv_font_montserrat_24;
    else if (cfg.style.fontSize >= 20) font = &lv_font_montserrat_20;
    else if (cfg.style.fontSize >= 14) font = &lv_font_montserrat_14;

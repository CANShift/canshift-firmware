...
constexpr MatrixRow kMatrix[] = {
    ...
    {"ANTI-LAG", ControlState::UNAVAILABLE, 0, "ANTI-LAG\nEGT HIGH", "LOCKED"},
    {"TRACTION", ControlState::OFF, 0, "TRACTION", "OFF"},
    {"TRACTION", ControlState::ARMED, 4, "TRACTION", "LEVEL 4"},
    {"TRACTION", ControlState::ACTIVE, 4, "TRACTION\nCUTTING", "LEVEL 4"},
    {"TRACTION", ControlState::UNAVAILABLE, 0, "TRACTION\nNO WHEEL SPEED", "N/A"},
    {"LAUNCH", ControlState::OFF, 0, "LAUNCH", "OFF"},
    {"LAUNCH", ControlState::ARMED, 4200, "LAUNCH\n4200 rpm", "ARMED"},
    {"LAUNCH", ControlState::ACTIVE, 4200, "LAUNCH\nHOLDING", "4200"},
    {"LAUNCH", ControlState::UNAVAILABLE, 0, "LAUNCH\nMOVING", "LOCKED"},
    {"PIT LIMIT", ControlState::OFF, 0, "PIT LIMIT", "OFF"},
    {"PIT LIMIT", ControlState::ACTIVE, 60, "PIT LIMIT\nHOLDING", "60"},
    {"PIT LIMIT", ControlState::UNAVAILABLE, 4, "PIT LIMIT\nGEAR 4", "LOCKED"},
    {"CRUISE", ControlState::OFF, 0, "CRUISE", "OFF"},
    {"CRUISE", ControlState::ARMED, 110, "CRUISE\nSET 110", "ARMED"},
    {"CRUISE", ControlState::ACTIVE, 110, "CRUISE\nHOLDING", "110"},
    {"CRUISE", ControlState::UNAVAILABLE, 0, "CRUISE\nBRAKE CUT", "CANCELLED"},
};
